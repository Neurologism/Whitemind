<template>
  <p>
    ...
    legal<br />
    terms (the 'Legal Terms') (collectively, the 'Services').<br />
    <br />
    We provide an AI platform that you can use to study, create, prototype,
    gather feedback and collaborate.<br />
    <br />
    You can contact us by email at info@whitemind.net or by mail to
    Spitzsteinstrasse 9, Brannenburg, Bavaria 83098, Germany.<br />
    <br />
    ...
    posting<br />
    or notifying you by info@whitemind.net, as stated in the email message. By
    continuing to use the Services after the effective date of any changes, you
    agree<br />
    to be bound by the modified terms.<br />
    <br />
    ...
    by,<br />
    their parent or guardian to use the Services. If you are a minor, you must
    ...
    11. SOCIAL MEDIA<br />
    12. THIRD-PARTY WEBSITES AND CONTENT<br />
    13. SERVICES MANAGEMENT<br />
    14. PRIVACY POLICY<br />
    15. COPYRIGHT INFRINGEMENTS<br />
    ...
    compliance<br />
    with local laws, if and to the extent local laws are applicable.<br />
    <br />
    <br />
    ...
    subjected to such laws, you may not use the Services. You may not use the<br />
    Services in a way that would violate the Gramm-Leach-Bliley Act (GLBA).<br />
    <br />
    <br />
    <br />
    2. INTELLECTUAL PROPERTY RIGHTS<br />
    ...
    your personal, non-commercial use only.<br />
    <br />
    ...
    <br />
    solely for your personal, non-commercial use.<br />
    ...
    commercial<br />
    purpose whatsoever, without our express prior written permission.<br />
    <br />
    ...
    your<br />
    request to: info@whitemind.net. If we ever grant you the permission to post,
    ...
    during<br />
    which you may create, submit, post, display, transmit, publish, distribute,
    ...
    treated as a Contribution.<br />
    <br />
    <br />
    You understand that Contributions may be viewable by other users of the
    Services and possibly through third-party websites.<br />
    <br />
    <br />
    When you post Contributions, you grant us a licence (including use of your
    name, trademarks, and logos): By posting any Contributions, you grant us<br />
    ...
    part), and exploit your<br />
    Contributions (including, without limitation, your image, name, and voice)
    for any purpose, commercial, advertising, or otherwise, to prepare
    derivative works<br />
    of, or incorporate into other works, your Contributions, and to sublicence
    the licences granted in this section. Our use and distribution may occur in
    any media<br />
    formats and through any media channels.<br />
    <br />
    <br />
    ...
    names,<br />
    logos, and personal and commercial images you provide.<br />
    <br />
    <br />
    You are responsible for what you post or upload: By sending us Submissions
    and/or posting Contributions through any part of the Services or making<br />
    Contributions accessible through the Services by linking your account
    through the Services to any of your social networking accounts, you:<br />
    <br />
    ...
    and report you to the authorities.<br />
    <br />
    ...
    Services will not violate any applicable law or regulation.<br />
    <br />
    <br />
    If you provide any information that is untrue, inaccurate, not current, or
    incomplete, we have the right to suspend or terminate your account and
    refuse any<br />
    and all current or future use of the Services (or any portion thereof).<br />
    <br />
    <br />
    <br />
    4. USER REGISTRATION<br />
    ...
    select if we determine, in our sole discretion, that such username is<br />
    inappropriate, obscene, or otherwise objectionable.<br />
    <br />
    <br />
    <br />
    5. PURCHASES AND PAYMENT<br />
    ...
    information for all purchases made via the Services. You further agree to<br />
    promptly update account and payment information, including email address,
    payment method, and payment card expiration date, so that we can complete<br />
    your transactions and contact you as needed. Sales tax will be added to the
    price of purchases as deemed required by us. We may change prices at any<br />
    time.<br />
    <br />
    ...
    already<br />
    requested or received payment.<br />
    <br />
    ...
    under the same customer account, the same payment method, and/or orders
    that<br />
    ...
    depend on the<br />
    type of subscription plan you choose when you subscribed to the Services.<br />
    <br />
    Cancellation<br />
    <br />
    ...
    communicate any price changes to you in accordance with applicable law.<br />
    <br />
    <br />
    <br />
    7. SOFTWARE<br />
    ...
    personal,<br />
    and non-transferable licence to use such software solely in connection with
    our services and in accordance with these Legal Terms. Any software and
    any<br />
    ...
    accept any and all risk arising out of use or performance of any software.
    You may<br />
    not reproduce or redistribute any software except in accordance with the
    EULA or these Legal Terms.<br />
    <br />
    <br />
    <br />
    8. PROHIBITED ACTIVITIES<br />
    You may not access or use the Services for any purpose other than that for
    which we make the Services available. The Services may not be used in<br />
    connection with any commercial endeavours except those that are specifically
    endorsed or approved by us.<br />
    ...
    compile, directly or indirectly, a collection, compilation, database, or<br />
    directory without written permission from us.<br />
    ...
    horses, or other material, including excessive use of capital letters and<br />
    spamming (continuous posting of repetitive text), that interferes with any
    partyâ€™s uninterrupted use and enjoyment of the Services or modifies,<br />
    ...
    comments or messages, or using any data mining, robots, or similar data<br />
    ...
    1Ã—1 pixels, web bugs, cookies, or other similar devices (sometimes referred
    to<br />
    ...
    reverse engineer any of the software comprising or in any way making up<br />
    a part of the Services.<br />
    ...
    and/or email addresses of users by electronic or other means for the<br />
    purpose of sending unsolicited email, or creating user accounts by automated
    means or under false pretences.<br />
    Use the Services as part of any effort to compete with us or otherwise use
    the Services and/or the Content for any revenue-generating endeavour or<br />
    ...
    identifiable individual person in your Contributions to use the name or<br />
    likeness of each and every such identifiable individual person to enable
    inclusion and use of your Contributions in any manner contemplated by the<br />
    Services and these Legal Terms.<br />
    ...
    those terms) any other person and to promote violence against a specific<br />
    person or class of people.<br />
    ...
    unrestricted, unlimited,<br />
    irrevocable, perpetual, non-exclusive, transferable, royalty-free,
    fully-paid, worldwide right, and licence to host, use, copy, reproduce,
    disclose, sell, resell,<br />
    ...
    authorise sublicences of the foregoing. The use and distribution may occur
    in any<br />
    media formats and through any media channels.<br />
    <br />
    This licence will apply to any form, media, or technology now known or
    hereafter developed, and includes our use of your name, company name, and<br />
    ...
    waive<br />
    all moral rights in your Contributions, and you warrant that moral rights
    have not otherwise been asserted in your Contributions.<br />
    <br />
    ...
    any<br />
    area on the Services. You are solely responsible for your Contributions to
    the Services and you expressly agree to exonerate us from any and all<br />
    ...
    without notice. We<br />
    have no obligation to monitor your Contributions.<br />
    <br />
    <br />
    <br />
    11. SOCIAL MEDIA<br />
    ...
    Account, and without obligating us to pay any fees or making us subject to
    any usage<br />
    ...
    THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR<br />
    THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH
    THIRD-PARTY SERVICE PROVIDERS. We make no effort<br />
    ...
    your email address book associated with a Third-Party Account and your<br />
    ...
    registered to<br />
    use the Services. You can deactivate the connection between the Services and
    your Third-Party Account by contacting us using the contact information<br />
    ...
    investigated, monitored, or checked for accuracy, appropriateness, or<br />
    ...
    Websites or any Third-<br />
    Party Content does not imply approval or endorsement thereof by us. If you
    decide to leave the Services and access the Third-Party Websites or to use
    or<br />
    install any Third-Party Content, you do so at your own risk, and you should
    ...
    applications you<br />
    use or install from the Services. Any purchases you make through Third-Party
    Websites will be through other websites and from other companies, and we<br />
    ...
    authorities; (3) in our<br />
    sole discretion and without limitation, refuse, restrict access to, limit
    the availability of, or disable (to the extent technologically feasible) any
    of your<br />
    ...
    our systems; and (5) otherwise manage the Services in a manner designed
    to<br />
    ...
    Germany. If you access the Services from any other region of the world with
    laws or<br />
    other requirements governing personal data collection, use, or disclosure
    that differ from applicable laws in Germany, then through your continued use
    of the<br />
    Services, you are transferring your data to Germany, and you expressly
    consent to have your data transferred to and processed in Germany.<br />
    <br />
    <br />
    <br />
    15. COPYRIGHT INFRINGEMENTS<br />
    ...
    advised that pursuant to applicable law you may be held liable for damages
    if you<br />
    ...
    pursuing civil, criminal, and injunctive redress.<br />
    <br />
    <br />
    <br />
    17. MODIFICATIONS AND INTERRUPTIONS<br />
    ...
    notice. However,<br />
    we have no obligation to update any information on our Services. We will not
    be liable to you or any third party for any modification, price change,
    suspension,<br />
    or discontinuance of the Services.<br />
    <br />
    ...
    otherwise modify<br />
    the Services at any time or for any reason without notice to you. You agree
    that we have no liability whatsoever for any loss, damage, or
    inconvenience<br />
    caused by your inability to access or use the Services during any downtime
    or discontinuance of the Services. Nothing in these Legal Terms will be
    construed<br />
    to obligate us to maintain and support the Services or to supply any
    corrections, updates, or releases in connection therewith.<br />
    <br />
    <br />
    <br />
    18. GOVERNING LAW<br />
    ...
    these<br />
    Legal Terms in Germany, or in the EU country in which you reside.<br />
    <br />
    <br />
    <br />
    19. DISPUTE RESOLUTION<br />
    ...
    negotiate any Dispute (except<br />
    ...
    Strasbourg, and<br />
    which are in force at the time the application for arbitration is filed, and
    of which adoption of this clause constitutes acceptance. The seat of
    arbitration shall be<br />
    Munich, Germany. The language of the proceedings shall be German. Applicable
    rules of substantive law shall be the law of Germany.<br />
    <br />
    Restrictions<br />
    <br />
    The Parties agree that any arbitration shall be limited to the Dispute
    between the Parties individually. To the full extent permitted by law, (a)
    no arbitration shall<br />
    be joined with any other proceeding; (b) there is no right or authority for
    any Dispute to be arbitrated on a class-action basis or to utilise class
    action<br />
    ...
    arising from,<br />
    allegations of theft, piracy, invasion of privacy, or unauthorised use; and
    (c) any claim for injunctive relief. If this provision is found to be
    illegal or<br />
    unenforceable, then neither Party will elect to arbitrate any Dispute
    falling within that portion of this provision found to be illegal or
    unenforceable and such<br />
    ...
    YOUR USE OF THE SERVICES WILL BE AT YOUR<br />
    SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL
    WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE<br />
    ...
    REPRESENTATIONS ABOUT THE ACCURACY OR<br />
    COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR
    MOBILE APPLICATIONS LINKED TO THE SERVICES<br />
    AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS,
    MISTAKES, OR INACCURACIES OF CONTENT AND<br />
    MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER,
    RESULTING FROM YOUR ACCESS TO AND USE<br />
    OF THE SERVICES, (3) ANY UNAUTHORISED ACCESS TO OR USE OF OUR SECURE SERVERS
    AND/OR ANY AND ALL PERSONAL INFORMATION<br />
    AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR
    CESSATION OF TRANSMISSION TO OR FROM THE SERVICES,<br />
    (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED
    TO OR THROUGH THE SERVICES BY ANY THIRD<br />
    PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR
    FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED<br />
    AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE
    AVAILABLE VIA THE SERVICES. WE DO NOT<br />
    WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR
    SERVICE ADVERTISED OR OFFERED BY A THIRD<br />
    PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR
    MOBILE APPLICATION FEATURED IN ANY BANNER OR<br />
    OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE
    RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN<br />
    YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE
    PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY<br />
    MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGEMENT AND
    EXERCISE CAUTION WHERE APPROPRIATE.<br />
    <br />
    <br />
    <br />
    22. LIMITATIONS OF LIABILITY<br />
    IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU
    OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT,<br />
    CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES,
    INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR<br />
    ...
    YOU FOR ANY CAUSE WHATSOEVER AND<br />
    REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE
    AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX<br />
    (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS
    AND INTERNATIONAL LAWS DO NOT ALLOW<br />
    LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN
    DAMAGES. IF THESE LAWS APPLY TO YOU, SOME<br />
    OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU
    MAY HAVE ADDITIONAL RIGHTS.<br />
    <br />
    <br />
    <br />
    23. INDEMNIFICATION<br />
    ...
    party<br />
    due to or arising out of: (1) your Contributions; (2) use of the Services;
    (3) breach of these Legal Terms; ( 4) any breach of your representations
    and<br />
    warranties set forth in these Legal Terms; (5) your violation of the rights
    ...
    you are required to indemnify us, and you agree to cooperate, at your<br />
    ...
    this<br />
    indemnification upon becoming aware of it.<br />
    <br />
    <br />
    <br />
    24. USER DATA<br />
    ...
    constitute electronic communications. You consent to receive electronic<br />
    communications, and you agree that all agreements, notices, disclosures, and
    other communications we provide to you electronically, via email and on
    the<br />
    Services, satisfy any legal requirement that such communication be in
    writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES,<br />
    CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES,
    POLICIES, AND RECORDS OF TRANSACTIONS<br />
    INITIATED OR COMPLETED BY US OR VIA THE SERVICES. You hereby waive any
    rights or requirements under any statutes, regulations, rules,<br />
    ...
    or<br />
    agency relationship created between you and us as a result of these Legal
    Terms or use of the Services. You agree that these Legal Terms will not
    be<br />
    construed against us by virtue of having drafted them. You hereby waive any
    and all defences you may have based on the electronic form of these Legal<br />
