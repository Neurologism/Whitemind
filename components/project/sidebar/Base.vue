...
<template>
  <div
    ...
    class="parent-div border-r-2 h-100 border-gray-600 bg-opacity-90 bg-bg-3 pt-4 pl-2 pb-2 w-20 origin-left transition-transform flex flex-row flex-nowrap select-none"
    :class="{
