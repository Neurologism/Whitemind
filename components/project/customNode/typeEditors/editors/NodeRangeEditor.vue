...
<template>
  <div class="w-full">
    ...
    <input
      ...
      ref="rangeRef"
      @input="inputCB"
      class="w-full z-50 inputRange cursor-default flex flex-row border-0 form-input rounded-md placeholder-gray-500 text-xs px-2 py-1 shadow-sm bg-bg-2 text-text-1 ring-1 ring-inset ring-gray-700 focus:ring-2 focus:ring-primary-400 focus:outline-none"
