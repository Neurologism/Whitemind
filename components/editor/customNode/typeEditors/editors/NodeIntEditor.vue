...
<template>
  <div class="w-full">
    <div
      class="flex-nowrap w-full inputRange cursor-default flex flex-row border-0 form-input rounded-md placeholder-gray-400 dark:placeholder-gray-500 text-xs shadow-sm px-0 py-1 bg-white dark:bg-gray-900 text-gray-900 dark:text-white ring-1 ring-inset dark:ring-gray-700 focus-within:ring-2 focus-within:ring-primary-500 focus-within:dark:ring-primary-400 focus-within:outline-none"
      :class="{
