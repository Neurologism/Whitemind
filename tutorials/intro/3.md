...
## 3
Now, connect the create Node to the input layer and the output layer 
...
## 10
Fantastic! Hit the big Start Training button at the top of the screen to kick off the training process.
